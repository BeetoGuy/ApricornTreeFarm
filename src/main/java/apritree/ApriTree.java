...
@Mod(name="Apricorn Tree Farm", modid="apritree", version="2.1.1", dependencies="required-after:pixelmon@[7.0.0,);after:betterwithmods;after:immersiveengineering;after:industrialforegoing;before:bonsaitrees")
