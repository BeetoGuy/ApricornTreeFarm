...
import apritree.block.BlockMechanicalDriver;
...
public class TileEntityMechanicalDriver extends TileEntityDriver
{
    ...
    {
        return this.getBlockType() == ApriRegistry.mechanicalDriver && world.getBlockState(pos).getValue(BlockMechanicalDriver.ACTIVE);
    }
