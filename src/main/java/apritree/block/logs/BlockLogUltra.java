...
public class BlockLogUltra extends BlockLog {
    ...
    public IBlockState getStateFromMeta(int meta) {
        IBlockState state = this.getDefaultState().withProperty(StateLibrary.APRICORNS6, EnumApricorns.byMeta((meta % 4) + 20));
        switch (meta & 12) {
            case 0:
    ...
    public int getMetaFromState(IBlockState state) {
        int i = state.getValue(StateLibrary.APRICORNS6).getMeta() - 20;
    ...
    protected BlockStateContainer createBlockState() {
        return new BlockStateContainer(this, StateLibrary.APRICORNS6, LOG_AXIS);
    }

    @Override
    protected ItemStack getSilkTouchDrop(IBlockState state) {
        return new ItemStack(this, 1, state.getValue(StateLibrary.APRICORNS6).getMeta() - 20);
    }
}
