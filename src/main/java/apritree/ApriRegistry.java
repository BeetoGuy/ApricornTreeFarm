...
import apritree.integration.BetterWithMods;
...
public class ApriRegistry
{
    ...
    {
        if (Loader.isModLoaded("betterwithmods") && ApriConfig.bwmDriverEnabled)
        {
            mechanicalDriver = new BlockMechanicalDriver();
            registerBlock(mechanicalDriver, "mech_driver");
            GameRegistry.registerTileEntity(TileEntityMechanicalDriver.class, "apritree_mechdriver");
        }
        if (Loader.isModLoaded("IC2") && ApriConfig.ic2DriverEnabled)
        {
            electricDriver = new BlockElectricDriver();
            registerBlock(electricDriver, "electric_driver");
            GameRegistry.registerTileEntity(TileEntityElectricDriver.class, "apritree_elecdriver");
        }
        if (ApriConfig.rfDriverEnabled) {
            energeticDriver = new BlockEnergeticDriver();
            registerBlock(energeticDriver, "energetic_driver");
            GameRegistry.registerTileEntity(TileEntityEnergyDriver.class, "apritree_enerdriver");
        }
        ...
        if (ApriConfig.apricornTreeCrafting) {
            for (int i = 0; i < 8; i++) {
        ...
        else if (ApriConfig.driversExist) {
    ...
    public static void initCrafting()
    {
        ...
        if (ApriConfig.masterBallCrafting && ApriConfig.driversExist) {
            ...
            if (Loader.isModLoaded("betterwithmods") && ApriConfig.bwmMasterBallCrafting) {
