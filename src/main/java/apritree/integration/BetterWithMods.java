...
public class BetterWithMods {
    public static void registerMasterball() {
        BWCrafting.addSteelShapedOreRecipe(new ItemStack(ApriRegistry.masterball, 1, 0), " MM ", "PMMP", 'M', new ItemStack(ApriRegistry.apricorn, 1, 1), 'P', new ItemStack(Item.REGISTRY.getObject(new ResourceLocation("pixelmon", "cooked_pink_apricorn"))));
    }
    ...
    public static void registerBuoyancy() {
        ...
        buoyancy.put(ApriRegistry.apricorn, OreDictionary.WILDCARD_VALUE, 1.0F);
