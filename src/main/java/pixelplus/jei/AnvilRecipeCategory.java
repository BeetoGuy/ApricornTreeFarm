...
public class AnvilRecipeCategory extends BlankRecipeCategory<AnvilRecipeWrapper>
{
    ...
    {
        background = helper.createDrawable(new ResourceLocation("pixelplus", "textures/gui/driver.png"), 37, 37, 103, 27);
        pokeball = helper.createAnimatedDrawable(helper.createDrawable(new ResourceLocation("pixelplus", "textures/gui/driver.png"), 176, 0, 14, 14), 200, IDrawableAnimated.StartDirection.BOTTOM, false);
    }
