...
import pixelplus.worldgen.WorldGenApricornTree;
...
public class BlockApricornSapling extends BlockBush implements IGrowable
{
    ...
    public BlockApricornSapling()
    {
        ...
        this.setUnlocalizedName("pixelplus:apricorn_sapling");
    ...
    private IBlockState getLeafState(EnumApricorns apricorn)
    {
        switch(apricorn)
        {
            case BLACK: return PixelRegistry.apricornLeafOne.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
            case WHITE: return PixelRegistry.apricornLeafOne.getDefaultState().withProperty(BlockApricornLeafOne.APRICORNS, EnumApricorns.WHITE).withProperty(BlockLeaves.CHECK_DECAY, false);
            case PINK: return PixelRegistry.apricornLeafOne.getDefaultState().withProperty(BlockApricornLeafOne.APRICORNS, EnumApricorns.PINK).withProperty(BlockLeaves.CHECK_DECAY, false);
            case GREEN: return PixelRegistry.apricornLeafOne.getDefaultState().withProperty(BlockApricornLeafOne.APRICORNS, EnumApricorns.GREEN).withProperty(BlockLeaves.CHECK_DECAY, false);
            case RED : return PixelRegistry.apricornLeafTwo.getDefaultState().withProperty(BlockApricornLeafTwo.APRICORNS, EnumApricorns.RED).withProperty(BlockLeaves.CHECK_DECAY, false);
            case BLUE: return PixelRegistry.apricornLeafTwo.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
            case YELLOW: return PixelRegistry.apricornLeafTwo.getDefaultState().withProperty(BlockApricornLeafTwo.APRICORNS, EnumApricorns.YELLOW).withProperty(BlockLeaves.CHECK_DECAY, false);
            case PURPLE: return PixelRegistry.apricornLeafTwo.getDefaultState().withProperty(BlockApricornLeafTwo.APRICORNS, EnumApricorns.PURPLE).withProperty(BlockLeaves.CHECK_DECAY, false);
            default: return PixelRegistry.apricornLeafOne.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, false);
        }
    }
